 ...
 * @author Saito
 */
public class dialogQuestD extends javax.swing.JDialog {
    int x,y,resultado;
    /**
     * Creates new form dialogYesNo
     */
    public dialogQuestD(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialogQuestD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialogQuestD dialog = new dialogQuestD(new javax.swing.JDialog(), true);
