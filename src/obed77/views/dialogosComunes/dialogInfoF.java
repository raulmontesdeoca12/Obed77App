 ...
 * @author Saito
 */
public class dialogInfoF extends javax.swing.JDialog {
    int x,y,resultado;
    /**
     * Creates new form dialogYesNo
     */
    public dialogInfoF(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialogInfoF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialogInfoF dialog = new dialogInfoF(new javax.swing.JFrame(), true);
