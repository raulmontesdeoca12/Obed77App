 ...
 * @author Saito
 */
public class dialogInfoD extends javax.swing.JDialog {
    int x,y,resultado;
    /**
     * Creates new form dialogYesNo
     */
    public dialogInfoD(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Icono_Info_55.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dialogInfoD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                dialogInfoD dialog = new dialogInfoD(new javax.swing.JDialog(), true);
